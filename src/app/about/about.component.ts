...
export class AboutComponent implements OnInit {
  ...
  description = 'Mission-driven Ui developer with almost 7 years of impeccable experience in full web development life cycle including front end and back end development. \n As a UI developer I enjoy creating new user interfaces rapidly. ';
